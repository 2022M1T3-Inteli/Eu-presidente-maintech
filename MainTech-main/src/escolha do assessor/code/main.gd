...
func _ready():
	...
	if(Global.fase == "01" or Global.fase == ""):
		...
		if Global.personagem == 1:
			$Sprite.texture = load ("res://imag/Captura_de_Tela_2022-03-09_às_15.00.11-removebg-preview.png")
		if Global.personagem == 2:
			$Sprite.texture = load("res://imag/Captura_de_Tela_2022-03-09_às_14.59.51-removebg-preview.png")
		if Global.personagem == 3:
			$Sprite.texture = load("res://imag/Captura_de_Tela_2022-03-09_às_14.59.59-removebg-preview.png")
