...
func _process(delta):
	...
	if(Global.gP + Global.gN >= 4 and Global.fase != "03"):
		$Importante_02.visible = true
		porta1 = false
	elif (Global.gP + Global.gN >= 8 and Global.fase == "03"):
		get_tree().change_scene("res://Telas/Node2D.tscn")
