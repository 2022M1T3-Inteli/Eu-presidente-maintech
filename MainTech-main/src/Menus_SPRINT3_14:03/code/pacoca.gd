...
func _process(delta):
	...
	if Input.is_action_pressed("ui_esq") and mouseKB4 == true:
		$KB4/AS4.frame = 1
		trava4 = true
		trava3 = true
		trava2 = true
		trava1 = true
	if Input.is_action_pressed("ui_dir") and mouseKB4 == true:
		$KB4/AS4.frame = 0
		trava4 = false
		trava3 = false
		trava2 = false
		trava1 = false
	if Input.is_action_pressed("ui_esq") and mouseKB3 == true:
		$KB3/AS3.frame = 1
		trava4 = true
		trava3 = true
		trava2 = true
		trava1 = true
	if Input.is_action_pressed("ui_dir") and mouseKB3 == true:
		$KB3/AS3.frame = 0
		trava4 = false
		trava3 = false
		trava2 = false
		trava1 = false
	if Input.is_action_pressed("ui_esq") and mouseKB2 == true:
		$KB2/AS2.frame = 1
		trava4 = true
		trava3 = true
		trava2 = true
		trava1 = true
	if Input.is_action_pressed("ui_dir") and mouseKB2 == true:
		$KB2/AS2.frame = 0
		trava4 = false
		trava3 = false
		trava2 = false
		trava1 = false
	if Input.is_action_pressed("ui_esq") and mouseKB1 == true:
		$KB1/AS1.frame = 1
		trava4 = true
		trava3 = true
		trava2 = true
		trava1 = true
	if Input.is_action_pressed("ui_dir") and mouseKB1 == true:
		$KB1/AS1.frame = 0
		trava4 = false
		trava3 = false
		trava2 = false
