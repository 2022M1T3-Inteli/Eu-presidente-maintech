...
func _process(delta):
	...
	if Input.is_action_pressed("ui_click") and mouseKB4 == true:
		Global.personagem = 4
		Global.genero.append(Global.masculino[0])
		Global.genero.append(Global.masculino[1])
		Global.genero.append(Global.masculino[2])
		$KB4/AS4.frame = 1
		trava4 = true
		trava3 = true
		trava2 = true
	...
	if Input.is_action_pressed("ui_click") and mouseKB3 == true:
		Global.personagem = 3
		Global.genero.append(Global.feminino[0])
		Global.genero.append(Global.feminino[1])
		Global.genero.append(Global.feminino[2])
		$KB3/AS3.frame = 1
		trava4 = true
		trava3 = true
		trava2 = true
