...
func criar_coletavel():
	var loadColetavel = preload("res://Minigame2/Cenas2/coletavel.tscn")# Carrega a cena do coletavel
...
func criar_obstaculo():
	var loadObstaculo = preload("res://Minigame2/Cenas2/obstaculo.tscn") # Carrega a cena do coletavel
